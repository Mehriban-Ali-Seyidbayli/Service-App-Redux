        ...
        <footer className="pt-4 my-md-5 pt-md-5 border-top">
            <div className="row">
                <div className="col-12 col-md">
                    <img className="mb-2" src="https://api.adoptez1artisan.com/storage/uploads/menu-logo.png" alt="" style={{ height: "60px" }} />
                            ...
                            categoriesState.categories.map((item, index) => {
                                ...
                                return (
                                    <li key={index} className="mb-1">
                                        <Link to={"/categories/" + item.slug} className="link-secondary text-decoration-none" href="#">
                                            {item.name}
                                        </Link>
                                    </li>
                                )
